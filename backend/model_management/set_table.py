...
class SetTable:
    ...
    def main(self):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['序号', '栏目等级', '名称', '静态资源目录', '查看图片', '添加时间'])
        self.tableWidget.horizontalHeader().setStretchLastSection(True)
        ...
        self.tableWidget.setColumnWidth(3, 650)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(4, 250)  # 设置列宽(第几列， 宽度)
