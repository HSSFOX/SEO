...
class SetTable:
    ...
    def main(self):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['', '序列号', '发布域名', '接口Token', '发布条数', '是否有手机版', '每日开始时间', '每日结束时间', '添加时间', '备注'])
        self.tableWidget.horizontalHeader().setStretchLastSection(True)
        self.tableWidget.setIconSize(QSize(100, 150))
        self.tableWidget.setColumnWidth(0, 70)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(1, 70)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(2, 400)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(3, 200)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(4, 200)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(5, 200)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(7, 200)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(8, 400)  # 设置列宽(第几列， 宽度)
