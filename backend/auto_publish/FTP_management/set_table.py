...
class SetTable:
    ...
    def main(self):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['FTP ID', 'FTP域名'])
        self.tableWidget.horizontalHeader().setStretchLastSection(True)
        self.tableWidget.setIconSize(QSize(100, 150))
        self.tableWidget.setColumnWidth(0, 200)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(1, 500)  # 设置列宽(第几列， 宽度)
        ...
        # self.tableWidget.setColumnWidth(7, 400)  # 设置列宽(第几列， 宽度)
