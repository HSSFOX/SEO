...
class SetTable:
    ...
    def main(self):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['名称', '配置', '添加时间'])
        ...
        self.tableWidget.setColumnWidth(1, 400)  # 设置列宽(第几列， 宽度)
        self.tableWidget.setColumnWidth(2, 150)  # 设置列宽(第几列， 宽度)
