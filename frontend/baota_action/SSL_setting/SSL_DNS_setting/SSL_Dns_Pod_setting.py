...
# Form implementation generated from reading ui file 'SSL_Dns_Pod_setting.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "  Token"))
        self.label_3.setText(_translate("Form", "- 使用DnsPod的API接口自动解析申请SSL\n"
