...
# Form implementation generated from reading ui file 'SSL_Ali_Dns_setting.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "设置接口"))
        self.label.setText(_translate("Form", "  AccessKey"))
        self.label_2.setText(_translate("Form", "  SecretKey"))
        self.label_3.setText(_translate("Form", "- 使用阿里云API接口自动解析申请SSL\n"
